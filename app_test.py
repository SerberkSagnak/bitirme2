"""
MINIMAL CLEAN DEEP LEARNING TEST ENDPOINT
"""
...
app = FastAPI(title="Clean Deep Learning Test")
security = HTTPBearer()
...
main_deep_learning_system = CleanDynamicDeepRecommender(
    embedding_dim=128, n_similar_users=10, similarity_threshold=0.1
)
...
if __name__ == "__main__":
    import uvicorn
    print("Starting Clean Deep Learning Test Server...")
